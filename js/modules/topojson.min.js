...
!function(n, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(topojson = topojson || {})
}(this, function(n) {
    "use strict";
    function t(n) {
        if (!n)
    ...
    function f(n, t, r) {
        ...
        function u(n) {
            "GeometryCollection" === n.type ? n.geometries.forEach(u) : n.type in s && (c = n,
            s[n.type](n.arcs))
        }
        var f = [];
        if (arguments.length > 1) {
            ...
            u(t),
            a.forEach(arguments.length < 3 ? function(n) {
                f.push(n[0].i)
            }
            : function(n) {
