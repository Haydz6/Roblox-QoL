...
async function RequestFunc(URL, Method, Headers, Body, CredientalsInclude, BypassResJSON){
    ...
    if (URL.search("roblox.com") > -1) {
        ...
        if (await HBAclient.isUrlIncludedInWhitelist(URL) || await IsFeatureKilled("EnforceHBAOnAllURLS")){
